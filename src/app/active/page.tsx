      ...
      >
        <div className="relative bg-white h-[90%] w-[200px] rounded-r-lg shadow my-auto p-5">
          ...
          <div
            ...
            className={`absolute ${
              isOpenQuestion ? "-right-4" : "-right-9"
            } bg-slate-600 text-white w-10 text-center flex justify-center items-center py-2 cursor-pointer hover:bg-slate-500 ease-in-out duration-300`}
          >
